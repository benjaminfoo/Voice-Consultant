...
public class Txt2Wav {
    ...
    public static void main(String[] args) throws Exception, MaryConfigurationException {
        new Txt2Wav().say("Hallo welt, wie geht es dir?");
    }

	public static void main2(String[] args) throws MaryConfigurationException {
		...
		try {
            ...
            mary.setVoice("bits1-hsmm"); // a German voice
	...
	public void say(String text) throws MaryConfigurationException, IOException, UnsupportedAudioFileException, LineUnavailableException, InterruptedException {
        // init mary
        LocalMaryInterface mary = null;
        try {
            mary = new LocalMaryInterface();
